    ...
    <>
      <section className="container mx-auto w-[80%] ">
        ...
        <div className="grid my-10 gap-4 grid-cols-3">
          <div className="p-4 flex items-center justify-center sm:justify-start gap-4 bg-gray-50 hover:bg-white dark:bg-darkPrimary hover:dark:bg-darkSecondary border rounded-sm border-gray-300 dark:border-neutral-400 transform origin-center md:origin-top group">
